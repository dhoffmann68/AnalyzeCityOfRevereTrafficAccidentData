...
class Revere2015(dml.Algorithm):
    contributor = 'darren68_gladding_ralcalde'
    reads = []
    writes = ['darren68_gladding_ralcalde.Revere2015']

    @staticmethod
    def execute(trial=False):
        '''Retrieve data set of crashes in Revere for the year 2015 and store it in Mongo'''
        ...
        url = 'http://datamechanics.io/data/darren68_gladding_ralcalde/REVERE2015updated.csv'
        ...
        repo.dropCollection("Revere2015")
        repo.createCollection("Revere2015")
        repo['darren68_gladding_ralcalde.Revere2015'].insert_many(dictList)
        repo['darren68_gladding_ralcalde.Revere2015'].metadata({'complete': True})
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        this_script = doc.agent('alg:darren68_gladding_ralcalde#Revere2015',
        ...
        crashes = doc.entity('dat:darren68_gladding_ralcalde#Revere2015',
